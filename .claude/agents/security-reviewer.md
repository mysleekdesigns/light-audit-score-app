...
- Secrets: no credentials/keys in code, tests, fixtures, or docs; runtime secrets
  (Anthropic/provider keys, Google key) stored via OS keychain only — never plaintext
