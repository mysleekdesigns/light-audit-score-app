...
import { AuditSessionProvider } from "@/components/audit/audit-session-provider";
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        <ThemeProvider>
          <TooltipProvider>
            {/* Audit sessions live at layout level so a running batch — and its
                live stream — survives navigating between pages. */}
